        ...
        <div className="flex items-center justify-between h-full">
          ...
          <div className="hidden lg:flex items-center space-x-3.5">
            <Button
              ...
              className="border-2 border-bizzwiz-magenta-flare/70 text-bizzwiz-magenta-flare hover:bg-bizzwiz-magenta-flare/15 hover:text-bizzwiz-star-white font-medium text-[13px] px-4 py-[0.85rem] rounded-lg transition-all duration-250 hover:shadow-[0_0_18px_hsla(var(--bizzwiz-magenta-flare-rgb),0.4)] hover:border-bizzwiz-magenta-flare transform hover:scale-103 group"
            >
              <PhoneCall size={16} className="mr-2 opacity-80 group-hover:opacity-100 transition-opacity"/>
              Planifier un Appel
            </Button>
            <Button
              variant="outline"
          ...
          >
            <div className="px-5 pt-4 pb-6 space-y-3 flex flex-col">
              ...
              <Button
                variant="outline"
                size="sm" 
                onClick={() => { navigate('/call'); setIsMobileMenuOpen(false); }}
                className="w-full justify-center border-2 border-bizzwiz-magenta-flare/80 text-bizzwiz-magenta-flare hover:bg-bizzwiz-magenta-flare/15 hover:text-bizzwiz-star-white font-medium py-2.5 rounded-lg text-[13px]"
              >
                <PhoneCall size={16} className="mr-2"/> Planifier un Appel
              </Button>
              <Button
                variant="outline"
                size="sm" 
