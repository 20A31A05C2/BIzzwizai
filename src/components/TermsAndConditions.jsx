        ...
        <div className="space-y-8 sm:space-y-12 md:space-y-16 max-w-4xl mx-auto">
          ...
          <motion.div variants={itemVariants}>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4 sm:mb-6 bg-gradient-to-b from-white to-gray-300 bg-clip-text text-transparent">
              {t('termsAndConditions.object.title')}
            </h2>
            <p className="text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed">
              {t('termsAndConditions.object.description')}
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4 sm:mb-6 bg-gradient-to-b from-white to-gray-300 bg-clip-text text-transparent">
              {t('termsAndConditions.responsibility.title')}
            </h2>
            <p className="text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed">
              {t('termsAndConditions.responsibility.description')}
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4 sm:mb-6 bg-gradient-to-b from-white to-gray-300 bg-clip-text text-transparent">
              {t('termsAndConditions.usage.title')}
            </h2>
            <p className="text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed">
              {t('termsAndConditions.usage.description')}
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4 sm:mb-6 bg-gradient-to-b from-white to-gray-300 bg-clip-text text-transparent">
              {t('termsAndConditions.services.title')}
            </h2>
            <p className="text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed">
          ...
          <motion.div variants={itemVariants}>
            ...
            <p className="text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed">
              {t('termsAndConditions.liability.description')}
            </p>
          </motion.div>
        </div>
      </motion.section>
