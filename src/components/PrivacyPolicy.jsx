        ...
        <div className="space-y-8 sm:space-y-12 md:space-y-16 max-w-4xl mx-auto">
          ...
          <motion.div variants={itemVariants}>
            ...
            <p className="text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed">
              {t('privacyPolicy.dataController.description')}
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="list-disc pl-5 sm:pl-6 md:pl-8 space-y-2 text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed">
              ...
              <li>{t('privacyPolicy.dataCollected.items.phone')}</li>
              <li>{t('privacyPolicy.dataCollected.items.projectInfo')}</li>
            </ul>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <p className="text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed mb-4">
              {t('privacyPolicy.purpose.intro')}
            </p>
            <ul className="list-disc pl-5 sm:pl-6 md:pl-8 space-y-2 text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed">
              <li>{t('privacyPolicy.purpose.items.communicate')}</li>
              <li>{t('privacyPolicy.purpose.items.analyze')}</li>
              <li>{t('privacyPolicy.purpose.items.monitor')}</li>
            </ul>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4 sm:mb-6 bg-gradient-to-b from-white to-gray-300 bg-clip-text text-transparent">
              {t('privacyPolicy.payments.title')}
            </h2>
            <p className="text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed">
              {t('privacyPolicy.payments.description')}
            </p>
          </motion.div>
