      ...
      <div className="divide-y divide-gray-100">
        ...
        <section className="p-5">
          ...
          <div className="space-y-2">
            ...
            <div><span className="font-medium text-gray-700">Fonte:</span> <span className="text-gray-600">{user.font}</span></div>
            <div>
              <span className="font-medium text-gray-700">Palette de couleurs:</span>
              <div className="flex flex-wrap gap-2 mt-1">
                {user.colorPalette && user.colorPalette.map((color, idx) => (
                  <span
                    key={idx}
