          ...
          {projects.length > 0 ? (
            ...
            >
              {projects.map((project, index) => (
                ...
                >
                  <Card
                    className={`rounded-3xl bg-white/10 backdrop-blur-2xl border border-white/20 p-6 shadow-lg hover:border-white/40 hover:shadow-lg hover:shadow-white/20 transition-all duration-300 ${
                      selectedProjectId === project.id ? 'border-purple-500/50 shadow-purple-500/20' : ''
                    }`}
                  >
                    <div className="w-12 h-12 bg-purple-600/20 backdrop-blur-sm rounded-xl mb-4 flex items-center justify-center border border-purple-500/30">
                      <svg className="w-6 h-6 text-purple-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012 2v2M7 7h10" />
                      </svg>
                    </div>
                    <h3 className="text-xl font-semibold text-white bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400 mb-2 line-clamp-2 font-montserrat">
                      {project.project_description || t('selectProject.project.untitled')}
                    </h3>
                    <div className="inline-flex items-center px-3 py-1 rounded-xl bg-white/5 backdrop-blur-sm border border-white/20 mb-3">
                      <span className="text-gray-300 text-sm font-medium font-montserrat">
                        {project.solution_type || t('selectProject.project.noType')}
                      </span>
                    </div>
                    <div className="flex items-center justify-between text-sm text-gray-300 mt-4 font-medium font-montserrat">
