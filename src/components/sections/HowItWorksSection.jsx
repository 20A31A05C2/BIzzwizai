...
//       className="w-full min-h-screen flex flex-col items-center justify-center bg-black text-white font-montserrat p-0"
//     >
...
//       <motion.div
//         className="relative max-w-6xl w-full mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-12 md:py-16 lg:py-20 pb-16 sm:pb-20 md:pb-24 lg:pb-28 xl:pb-32 mt-[120px] mb-[420px] md:mt-0 md:mb-0"
...
export function HowItWorksSection() {
  ...
  const y = useTransform(scrollYProgress, [0, 1], ["-10%", "10%"]); // Reduced transform range to minimize overlap
