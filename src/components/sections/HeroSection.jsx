  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="p-[2px] rounded-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
  <Button 
    size="lg"
    className="w-full h-full rounded-full bg-black text-xs md:text-sm px-7 md:px-9 py-3.5 md:py-4 group"
